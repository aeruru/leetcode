class Solution:
    ...
    # creating the lexographically smallest pallindrome. Lexographically smallest
    ...
    def makeSmallestPalindrome(self, s: str) -> str:
        ...
        for i in range(len(listS)//2):
            ...
            # string. So leteter at index 0 should be compared with letter at index -1,
            # letter at index 1 compared with letter at index -2, and so on.
